...
function HabitCard({ habit, isCompleted, completedCount, onComplete, onDelete, onSkip }) {
    ...
    if (isCompleted) {
        return (
            <>
                <div className="habit-card-completed" onClick={() => navigate(`/habit/${habit.id}`, { state: { from: "today" } })}>
                    {illustrationUrl ? (
                    ...
                    <div className="completed-body">
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                                    <div className="progress-dots">
                                        {Array.from({ length: habit.times_per_day }).map((_, i) => (
                                            <div key={i} className="dot" style={{ background: habit.color }} />
                                        ))}
                                    </div>
                        ...
                        <div className="icon-btns" style={{ marginTop: "8px", justifyContent: "flex-end" }}>
    ...
    return (
        <>
            <div className="habit-card-incomplete" onClick={() => navigate(`/habit/${habit.id}`, { state: { from: "today" } })}>
                {illustrationUrl ? (
